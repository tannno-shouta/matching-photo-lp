  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      {allowVideo && !shouldReduceMotion && (
        <video
          className="absolute inset-x-0 top-1/2 -translate-y-1/2 w-full aspect-video object-cover [mask-image:linear-gradient(to_bottom,transparent,black_18%,black_82%,transparent)] sm:inset-0 sm:top-0 sm:translate-y-0 sm:h-full sm:aspect-auto sm:[mask-image:none] transition-opacity duration-1000"
