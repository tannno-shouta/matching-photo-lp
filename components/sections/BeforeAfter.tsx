...
const CHANGE_POINTS = [
  {
    label: '眉・ヘア',
    detail: '眉毛サロンで眉毛を整え、黒髪センターパートで輪郭をシャープに。清潔感がありつつ、大人っぽく色気のある髪型を演出しました。',
  },
  {
    label: '服装',
    detail: '黒シャツで落ち着きと色気を演出。好み女性から逆算した、大人っぽい配色・丈感に。',
  },
  {
    label: 'ポージング・構図',
    detail: '実際にデートを想定した構図で自然な仕草を切り出し、陰影のあるムード背景で大人の余裕を演出しました。',
  },
];
